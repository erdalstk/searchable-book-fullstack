...
const Term = () => (
  <div>
    ...
    <p>
      ...
      using the https://books.haoict.com website (the "Service") operated by MDSTBooks ("us", "we",
      or "our").
    </p>
    ...
    <p>
      ...
      controlled by MDSTBooks.
    </p>

    <p>
      MDSTBooks has no control over, and assumes no responsibility for, the content, privacy
      policies, or practices of any third party web sites or services. You further acknowledge and
      agree that MDSTBooks shall not be responsible or liable, directly or indirectly, for any
    ...
    <p>
      These Terms shall be governed and construed in accordance with the laws of Japan, without
