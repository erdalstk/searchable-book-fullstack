...
const PrivacyPolicy = () => (
  <div>
    ...
    <p>
      MDSTBooks ("us", "we", or "our") operates the https://books.haoict.com website (hereinafter
    ...
    <p>
      ...
      Privacy Policy is managed by MDSTBooks
    </p>
    ...
    <p>
      ...
      Terms and Conditions, accessible from https://books.haoict.com
    </p>
    ...
    <ul>
      <li>
        ...
        <p>Service is the https://books.haoict.com website operated by MDSTBooks</p>
      </li>
      <li>
        <p>
    ...
    <p>MDSTBooks uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      If you are located outside Japan and choose to provide information to us, please note that we
      transfer the data, including Personal Data, to Japan and process it there.
    </p>
    <p>
    ...
    <p>
      MDSTBooks will take all steps reasonably necessary to ensure that your data is treated
    ...
    <p>
      MDSTBooks may disclose your Personal Data in the good faith belief that such action is
      necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of MDSTBooks</li>
    ...
    <ul>
      <li>By email: hao.ict56@gmail.com</li>
    </ul>
  </div>
);
