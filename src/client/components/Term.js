...
const Term = () => (
  <div>
    ...
    <p>Last updated: September 13, 2018</p>

    <p>
      Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the
      https://books.haoict.com website (the "Service") operated by MDSTBooks ("us", "we", or "our").
    </p>
    ...
    <p>
      Our Service may contain links to third-party web sites or services that are not owned or controlled by MDSTBooks.
    </p>

    <p>
      MDSTBooks has no control over, and assumes no responsibility for, the content, privacy policies, or practices of
      any third party web sites or services. You further acknowledge and agree that MDSTBooks shall not be responsible
    ...
    <p>
      These Terms shall be governed and construed in accordance with the laws of Japan, without regard to its conflict
      of law provisions.
    </p>
