...
const PrivacyPolicy = () => (
  <div>
    ...
    <p>
      MDSTBooks ("us", "we", or "our") operates the https://books.haoict.com website (hereinafter referred to as the
      "Service").
    </p>
    ...
    <p>
      If you are located outside Japan and choose to provide information to us, please note that we transfer the data,
      including Personal Data, to Japan and process it there.
    </p>
    <p>
    ...
    <p>
      MDSTBooks will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
    ...
    <p>MDSTBooks may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
